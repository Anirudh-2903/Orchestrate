                                ...
                                <FormControl className="h-72">
                                    <div className="flex-center h-[55px] w-full overflow-hidden rounded-full bg-grey-50 px-4 py-2">
                                        ...
                                        <DatePicker selected={field.value} onChange={(date: Date) =>
                                            field.onChange(date)} showTimeSelect timeInputLabel="Time:"
                                            dateFormat="dd/MM/yyyy h:mm aa" wrapperClassName="datePicker" />
                                    </div>
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem className="w-full">
                                <FormControl className="h-72">
                                    <div className="flex-center h-[55px] w-full overflow-hidden rounded-full bg-grey-50 px-4 py-2">
                                        <Image src={Rupee} alt="rupee" width={14} height={14} className="filter-grey" />
